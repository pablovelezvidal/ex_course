defmodule GameOfStones.GameServer do
  ...
  """
  def start_link(_) do
    #Possible conditions for the game
    # :started, :game_in_progress, :game_ended
    IO.puts "Starting Game Server..." |> Colors.green
  ...
  defp do_take({player, num_stones, current_stones}) do
    ...
    new_num_stones = current_stones - num_stones
    { :reply, {:next_turn, next_p, new_num_stones}, {next_p, new_num_stones, :game_in_progress}}
    # do_take()
  end
